...
totalPeriod: "2024 - 2028",
roles: [
  {
    title: "Junior Executive (Competitive Programming)",
    period: "2024 - Present",
    description: "Working in competitive programming activities, assisting in contest organization and problem solving initiatives.",
...
roles: [
  {
    ...
    period: "2026 - Present",
    description: "Designed and developed competitive programming problems for internal contests and club events.",
    technologies: ["C++", "Data Structures", "Algorithms"],
  },
],
  },
  {
    company: "Gen Z Coaching",
location: "Online",
totalPeriod: "2024 - Present",
roles: [
  {
    title: "Founder & Senior Teacher (Math & ICT)",
    period: "2024 - Present",
    description: "Founded an online coaching platform and teach Mathematics and ICT. Focused on SSC and HSC level students with structured learning support.",
    technologies: ["Mathematics", "ICT", "Teaching", "Curriculum Design"],
  },
],
  },
];
