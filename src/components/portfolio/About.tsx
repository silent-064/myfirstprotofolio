        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground text-lg leading-relaxed mb-8 text-justify">
              <p>
                I'm <span className="text-foreground font-semibold">Protic Prappo Durjoy</span>,
                a competitive programming enthusiast and student developer who enjoys solving algorithmic problems and building logical solutions.
              </p>
              <p>
                When I'm not solving algorithmic problems or participating in contests, I explore full-stack development. Competitive programming is my core passion, and I enjoy pushing myself through challenging problems.
              </p>
              <p>
               My journey in tech started with curiosity and has grown into a strong interest in algorithms and software development.
              </p>
            </div>
