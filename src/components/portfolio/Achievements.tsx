...
description: "Participated in university-level competitive programming contests",
icon: Trophy,
...
description: "Achieved Pupil rating (1200+) on Codeforces through competitive programming and problem solving",
icon: Star,
...
description: "Achieved 2-star rating on CodeChef through competitive programming contests",
icon: Star,
color: "from-orange-400 to-yellow-500",
year: "2025",
  },
  {
   title: "Hello Niter Programming Contest",
description: "Earned 2nd Runner-Up position representing error_19 in a programming contest",
icon: Award,
...
year: "2025",
  },
  {
    ...
    description: "Solved 1000+ algorithmic problems across multiple competitive platforms",
    icon: Target,
...
description: "Worked as a problem setter for Niter Eid Salami Contest 2.0",
icon: Zap,
