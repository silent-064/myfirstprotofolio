...
const socialLinks = [
  { icon: Github, href: "https://github.com/silent-064", label: "GitHub" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/protic-prappo-durjoy-648a4a352/", label: "LinkedIn" },
  { icon: Facebook, href: "https://www.facebook.com/durjoy.roy.3150", label: "Facebook" },
  { icon: Twitter, href: "https://x.com/durjoyroy3150", label: "Twitter" },
  { icon: Mail, href: "mailto:durjoyr2@gmail.com", label: "Email" },
];
      ...
      <div className="container mx-auto px-6 py-12 md:py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            Ready to contribute as a competitive programmer and developer
            </p>
            <motion.a
              href="/#contact"
